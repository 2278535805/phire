...
item-offline-sub = オフラインモードでの記録はアップロードできません
item-lowq = 低画質モード
item-lowq-sub = UIがラグい場合に有効化する

item-adjust = 自動時刻
item-adjust-sub = 音楽とビートマップを同期させるために、動的に時間を調整する
item-music = BGMの音量
item-sfx = 音響効果ボリューム
item-cali = 判定調整
...
item-play-config-sub = Perfect / Good / Bad の判定窓をカスタマイズ
